...
const emailLogin = async (req, res) => {
  ...
  const { firstName, lastName, _id, userName } = user._doc;

  res
    .status(200)
    .json({ _id, firstName, lastName, userName, email, accessToken }); //TODO CHANGE TO NAME ALONE
};
...
const userNameLogin = async (req, res) => {
  ...
  const { firstName, lastName, _id, email } = user._doc;
